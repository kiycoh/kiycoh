...
USER_NAME = os.environ['USER_NAME'] # 'kycoh'
...
if __name__ == '__main__':
    """
    Alessandro Carosia, 2026
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'kiycoh'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    bday = datetime.datetime.strptime(os.environ['BIRTHDAY'], '%Y-%m-%d')
    age_data, age_time = perf_counter(daily_readme, bday)
